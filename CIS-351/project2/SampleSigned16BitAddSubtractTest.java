...
public class SampleSigned16BitAddSubtractTest {
  ...
  @Test
  public void zero_n_one_add() {
    verify(0, -1, false);
  }

  @Test
  public void zero_n_one_subtract() {
    verify(0, -1, true);
  }
  
  @Test
  public void n_one_zero_add() {
    verify(-1, 0, false);
  }

  @Test
  public void n_one_zero_subtract() {
    verify(-1, 0, true);
  }
  
  @Test
  public void max_max_add() {
	verify(Short.MAX_VALUE, Short.MAX_VALUE, false);
  }
  
  @Test
  public void max_max_subtract() {
	verify(Short.MAX_VALUE, Short.MAX_VALUE, true);
  }
  
  @Test
  public void min_min_add() {
	verify(Short.MIN_VALUE, Short.MIN_VALUE, false);
  }

  @Test
  public void min_min_subtract() {
